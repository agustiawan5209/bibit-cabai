                            ...
                            <div class="card-body">
                                <div class="m-sm-4">
                                    ...
                                    <form action="{{ route('daftar.proses') }}" method="post">
                                        @csrf
                                        <div class="mb-3">
                                            <label class="form-label text-white">Nama Petani</label>
                                            <input class="form-control form-control-lg" type="text"
                                                name="nama_petani" placeholder="Nama Petani" required
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label text-white">Kelompok Tani</label>
                                            <input class="form-control form-control-lg" type="text"
                                                name="kelompok_tani" placeholder="Kelompok Tani" required
                                                value="{{ old('kelompok_tani') }}" />
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label text-white">Username</label>
                                            <input class="form-control form-control-lg" type="text" name="user"
                                                placeholder="Username" required value="{{ old('user') }}" />
                                            @if ($errors->has('user'))
