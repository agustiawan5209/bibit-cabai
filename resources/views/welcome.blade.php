...
<head>
        ...
        <script data-search-pseudo-elements="" defer="" src="{{asset('ajax/libs/font-awesome/6.4.0/js/all.min.js')}}" crossorigin="anonymous"></script>
                            ...
                            <div class="container px-5">
                                <div class="row gx-5 align-items-center">
                                    <div class="col-lg-6" data-aos="fade-up">
                                        <h1 class="page-header-ui-title">IMPLEMENTASI ALGORITMA K-NEAREST NEIGHBOR (KNN)</h1>
                                    ...
                                    <div class="col-lg-6 d-none d-lg-block" data-aos="fade-up" data-aos-delay="100"><img class="img-fluid" src="img/pngegg.png" /></div>
                                </div>
                            </div>
                        </div>
